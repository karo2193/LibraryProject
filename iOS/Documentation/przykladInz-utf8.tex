...
\autor{Adam Wojkowski}{112233}{12} {Wkład pracy tego autora}
	
\autor{Malwina Borecka-Xsinska}{112233}{30}
	{Wkład pracy tego autora dalej,
	Wkład pracy tego autora dalej,
	Wkład pracy tego autora dalej,
...
\autor{Stanisław Morski}{112233}{40}	
{Wkład pr. Morskiego}
...
\begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{img/ios1.PNG}
    \caption{Niewypełniony ekran wyszukiwania książki}
    \label{fig:iosSearchEmpty}
\end{minipage}%
\begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{img/ios3.PNG}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\linewidth]{img/ios2.PNG}
...
\begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{img/ios4.PNG}
    \caption{Ekran wyników wyszukiwania}
    \label{fig:iosResults}
\end{minipage}%
\begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{img/ios5.PNG}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\linewidth]{img/ios6.PNG}
  \includegraphics[width=0.4\linewidth]{img/ios7.PNG}
...
\bibitem{raportBN} http://www.bn.org.pl/aktualnosci/1338-czytelnictwo-polakow-2016-\%E2\%80\%93-raport-biblioteki-narodowej.html
\bibitem{clean_code}
Robert C. Martin. 
...
\bibitem{AppleDeveloper} https://developer.apple.com/documentation/
\bibitem{Rswift} https://github.com/mac-cain13/R.swift
\bibitem{UIEmptyState} https://github.com/luispadron/UIEmptyState
